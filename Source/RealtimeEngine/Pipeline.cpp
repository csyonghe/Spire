...
#include "CoreLib/Graphics/GGX.h"
...
namespace RealtimeEngine
{
	...
	List<ShaderChoice> EnginePipeline::GetChoices(String shaderName, const EnumerableDictionary<String, Spire::Compiler::ShaderChoiceValue>& existingChoices)
	{
		...
		{
			SpireLib::CompileShaderSource(result, Path::ReplaceExt(shaderFileName, L"shader"), options);
			result.PrintError();
		}
	...
	UniformValue ParseUniform(String & name, String dir, DeviceResourcePool * engine, Parser & parser)
	{
		auto parseTextureStorage = [](Parser & parser)
		{
